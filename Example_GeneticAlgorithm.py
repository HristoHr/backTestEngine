...
new_population = numpy.random.randint(low=-4, high=4, size=pop_size)
...
#    print("Generation : ", generation)
    ...
    print(new_population[0:parents.shape[0], :])
    print(new_population[parents.shape[0]:, :])
